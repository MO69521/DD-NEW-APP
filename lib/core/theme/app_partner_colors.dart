...
abstract final class AppPartnerColors {
  ...
  static const Color primaryDisabled = Color(0x4DFF4D88); // light-audit: keep-dark 品牌粉 tint，两态皆可读
  static const Color primaryMutedBg = Color(0x1FFF4D88); // light-audit: keep-dark
  static const Color primarySubtleBg = Color(0x14FF4D88); // light-audit: keep-dark
  ...
  static const Color tagPurpleLight = Color(0xFFD4C8FF); // light-audit: keep-dark
  static const Color tagPurpleMuted = Color(0xFF8B7EC8); // light-audit: keep-dark
  static const Color tagPurpleBg = Color(0x24B8A4FF); // light-audit: keep-dark
  static const Color tagPurpleBorder = Color(0x38B8A4FF); // light-audit: keep-dark
  ...
  /// 封面叠加标题阴影。
  static const Color coverTitleShadow = Color(0x80000000); // light-audit: effect 封面图上文字阴影

  /// 卡片 pressed 遮罩。
  static const Color cardPressedOverlay = Color(0x1AFFFFFF); // light-audit: effect 按压高光遮罩
  ...
  // ── 消息 Tab ──
  /// 顶栏下方粉紫光晕渐变顶色。
  static const Color messageHeaderGlowTop = Color(0x4DFF4D88); // light-audit: keep-dark 装饰粉紫光晕

  /// 顶栏下方粉紫光晕渐变过渡色。
  static const Color messageHeaderGlowMid = Color(0x1FB8A4FF); // light-audit: keep-dark 装饰粉紫光晕

  /// 会话行分隔线：深色 8% 白 / 浅色分割线（消息面在实体面上）。
  static const Color messageRowDivider =
  ...
  static const Color interactionHeaderBg = Color(0x99331E25); // light-audit: keep-dark 沉浸场景

  static const Color interactionHeaderGradientEnd = AppColors.black00;

  static const Color interactionCharacterCardBg = Color(0x80090E17); // light-audit: keep-dark 沉浸场景

  static const Color interactionSideActionBg = Color(0x66090E17); // light-audit: keep-dark 沉浸场景

  static const Color interactionReviewButtonBg = Color(0xCC3D3428); // light-audit: keep-dark 沉浸场景

  static const Color interactionPageIndicatorBg = AppColors.bgTint60;

  static const Color interactionConfideButton = primary;

  static const Color interactionChatButton = Color(0xFFD4A853); // light-audit: keep-dark 沉浸场景金按钮
