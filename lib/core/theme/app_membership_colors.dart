...
abstract final class AppMembershipColors {
  ...
  static const Color planSelectedBg = Color(0x14FFE794); // light-audit: keep-dark 金 8% 选中底（金恒定）
  static const Color planSelectedBorder = Color(0xFFFFE794); // light-audit: keep-dark 金描边
  ...
  static const Color planSelectedSecondary =
  ...
  static const Color planUnselectedBg =
  ...
  static const Color ctaGradientStart = Color(0xFFFFE794); // light-audit: keep-dark 开通金渐变（金恒定）
  static const Color ctaGradientEnd = Color(0xFFFFCD5A); // light-audit: keep-dark 开通金渐变
  ...
  // ── 权益网格 ──
  static const Color benefitIconBg =
      _isLight ? AppColors.surfaceSoft : AppColors.white05;
  ...
  static const Color agreementLink =
