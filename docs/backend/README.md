...
> 页面数据来源 / Repository / Model 总览、以及**分阶段接入计划与最小首批清单**已并入研发知识库 [../08_API.md](../08_API.md)（另见 [../06_Pages.md](../06_Pages.md)、[../07_DataFlow.md](../07_DataFlow.md)）。
...
1. 先看研发知识库 [../08_API.md](../08_API.md)，了解页面数据来源与接口清单。
